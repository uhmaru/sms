...
module Mongoid
  ...
  # source://mongoid/8.1.10/lib/mongoid.rb#105
  def client(name); end
  ...
  # source://mongoid/8.1.10/lib/mongoid.rb#73
  ...
  # source://mongoid/8.1.10/lib/mongoid.rb#85
  ...
  # source://mongoid/8.1.10/lib/mongoid.rb#95
...
module Mongoid::Document
  ...
  # source://mongoid/8.1.10/lib/mongoid/document.rb#103
  def initialize(attrs = T.unsafe(nil), &block); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#30
  def __selected_fields; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#30
  def __selected_fields=(_arg0); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#135
  def as_document; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#164
  def as_json(options = T.unsafe(nil)); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#184
  def becomes(klass); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#50
  def freeze; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#60
  def frozen?; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#74
  def hash; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#86
  def identity; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#113
  def model_name; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#31
  def new_record; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#123
  def to_key; end

  private

  # source://mongoid/8.1.10/lib/mongoid/document.rb#281
  def as_attributes; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#231
  def construct_document(attrs = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#259
  def logger; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#269
  def model_key; end
...
module Mongoid::Document::ClassMethods
  ...
  # source://mongoid/8.1.10/lib/mongoid/document.rb#415
  def _mongoid_clear_types; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#404
  def _types; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#393
  def construct_document(attrs = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#423
  def i18n_scope; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#327
  def instantiate(attrs = T.unsafe(nil), selected_fields = T.unsafe(nil), &block); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#348
  def instantiate_document(attrs = T.unsafe(nil), selected_fields = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#433
  def logger; end

  # source://mongoid/8.1.10/lib/mongoid/document.rb#306

...
class Dry::AutoInject::Builder
  ...
  # source://dry-auto_inject//lib/dry/auto_inject/builder.rb#27
  def method_missing(name, *_arg1, **_arg2, &_arg3); end

  # @return [Boolean]
  #
  # source://dry-auto_inject//lib/dry/auto_inject/builder.rb#23
...
class Dry::AutoInject::DependencyMap
  ...
  # source://dry-auto_inject//lib/dry/auto_inject/dependency_map.rb#29
  def names; end
  ...
  #
  # source://dry-auto_inject//lib/dry/auto_inject/dependency_map.rb#48
  def add_dependency(name, identifier); end

  # source://dry-auto_inject//lib/dry/auto_inject/dependency_map.rb#38
...
class Dry::AutoInject::Injector < ::BasicObject
  ...
  # source://dry-auto_inject//lib/dry/auto_inject/injector.rb#32
  def method_missing(name, *_arg1, **_arg2, &_arg3); end

  # @return [Boolean]
  #
  # source://dry-auto_inject//lib/dry/auto_inject/injector.rb#28
  def respond_to_missing?(name, _ = T.unsafe(nil)); end
end
...
class Dry::AutoInject::MethodParameters
  ...
  # @return [Boolean]
  #
  # source://dry-auto_inject//lib/dry/auto_inject/method_parameters.rb#60
  def empty?; end
  ...
  # @return [Boolean]
  #
  # source://dry-auto_inject//lib/dry/auto_inject/method_parameters.rb#64
...
class Dry::AutoInject::Strategies::Args < ::Dry::AutoInject::Strategies::Constructor
  ...
  # @api private
  #
  # source://dry-auto_inject//lib/dry/auto_inject/strategies/args.rb#24
  def define_initialize(klass); end

  # @api private
  #
  # source://dry-auto_inject//lib/dry/auto_inject/strategies/args.rb#37
  def define_initialize_with_params; end

  # @api private
  #
  # source://dry-auto_inject//lib/dry/auto_inject/strategies/args.rb#50
...
class Dry::AutoInject::Strategies::Hash < ::Dry::AutoInject::Strategies::Constructor
  ...
  # @api private
  #
  # source://dry-auto_inject//lib/dry/auto_inject/strategies/hash.rb#24
  def define_initialize(klass); end

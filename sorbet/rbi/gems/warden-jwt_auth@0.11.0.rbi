...
module Warden::JWTAuth
  ...
  # source://warden-jwt_auth//lib/warden/jwt_auth.rb#35
  def constantize_values(hash); end

  # source://warden-jwt_auth//lib/warden/jwt_auth.rb#24
  def symbolize_keys(hash); end

  # source://warden-jwt_auth//lib/warden/jwt_auth.rb#28
...
class Warden::JWTAuth::Strategy < ::Warden::Strategies::Base
  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#20
  def authenticate!; end

  # @return [Boolean]
  #
  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#16
  def store?; end

  # @return [Boolean]
  #
  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#12
  def valid?; end
  ...
  # @return [Boolean]
  #
  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#30
  def path_is_dispatch_request_path?; end

  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#52
  def token; end

  # @return [Boolean]
  #
  # source://warden-jwt_auth//lib/warden/jwt_auth/strategy.rb#48
